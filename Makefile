#############################################################################
# Makefile for building: PengLib
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Oct 8 09:44:27 2017
# Project:  PengLib.pro
# Template: app
# Command: /usr/local/Trolltech/Qt-4.7.4/bin/qmake -spec /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++ -o Makefile PengLib.pro
#############################################################################
...
Makefile: PengLib.pro  /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++/qmake.conf /usr/local/Trolltech/Qt-4.7.4/mkspecs/common/g++.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/common/unix.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/common/linux.conf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/qconfig.pri \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/modules/qt_webkit_version.pri \
		...
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/features/lex.prf \
		/usr/local/Trolltech/Qt-4.7.4/mkspecs/features/include_source_dir.prf
	$(QMAKE) -spec /usr/local/Trolltech/Qt-4.7.4/mkspecs/linux-g++ -o Makefile PengLib.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/PengLib1.0.0 || $(MKDIR) .tmp/PengLib1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/PengLib1.0.0/ && (cd `dirname .tmp/PengLib1.0.0` && $(TAR) PengLib1.0.0.tar PengLib1.0.0 && $(COMPRESS) PengLib1.0.0.tar) && $(MOVE) `dirname .tmp/PengLib1.0.0`/PengLib1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/PengLib1.0.0
...
PLString.o: PLString.cpp PLString.h \
		Object.h \
		Exception.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o PLString.o PLString.cpp
